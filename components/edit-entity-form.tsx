...
export default function EditEntityForm( {initialData , slug, toast}: {initialData: Entity, slug: string, toast: any}) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(getApiUrl(`/admin/edit-entity/${slug}`), {
        method: "PUT",
        headers: {
